                ...
                <div class="row mt-5 justify-content-center">
                    ...
                    <div class="col-md-3 d-none">
                        <div class="image-input ">
                            ...
                            <input type="file" name="flag" placeholder="@lang('Choose image')" id="image">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <select name="short_name" class="select2-single form-control @error('short_name') is-invalid @enderror" id="short_name">
                                @foreach(config('languages.langCodeWithoutFlag') as $key => $value)
                        ...
                        <div class="form-row mt-5">
                            <div class="col-md-4">
                                <div class="form-group ">
                                    ...
                                    <div class="custom-switch-btn w-md-75">
                                        ...
                                        <input type="checkbox" name="is_active" class="custom-switch-checkbox"

                                               id="is_active"  value = "0"  <?php if( $language->is_active == 0):echo 'checked'; endif ?>>
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    ...
                                    <div class="custom-switch-btn w-md-75">
                                        <input type='hidden' value="1" name='default_status'>
                                        <input type="checkbox" name="default_status" class="custom-switch-checkbox"

                                               id="default_status"  value = "0"  <?php if( $language->default_status == 0):echo 'checked'; endif ?>>
                                        <label class="custom-switch-checkbox-label" for="default_status">
                                            <span class="custom-switch-checkbox-inner"></span>
                                            <span class="custom-switch-checkbox-switch"> </span>
                                        </label>
                                    </div>
