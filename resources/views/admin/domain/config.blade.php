                                        ...
                                        <div class="row">
                                            @php
                                                $home = [
                                                    ...
                                                    'load_wallpaper_by_category' => 'Load Wallpaper By Category',
                                                ];
                                                ...
                                                <div class="col-sm-6 col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        @foreach($loads as  $load)
                                                            <input class="form-control" type="radio" name="manage_home[{{ $key }}]" id="{{ $key }}" />
                                                            <label>{{ $load }}</label>
                                                        @endforeach
                                                    </div>
                                                </div>
            ...
            const tableLoadDomain = setupDataTable(
                ...
                function (row, data) {
                    ...
                    $(row).on('click', function () {
                        var url = "{{ route('admin.domain.config', ['id' => ':id']) }}";
